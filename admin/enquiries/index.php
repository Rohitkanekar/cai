...
<div class="modal fade" id="deleteEnquiryModal" tabindex="-1" aria-labelledby="deleteEnquiryModalLabel"
    aria-hidden="true">
...
<script>
    ...
    if (deleteEnquiryModal) {
        ...
        deleteEnquiryModal.addEventListener("show.bs.modal", function (event) {
            ...
            document.getElementById("confirmDeleteEnquiry").href =
                "delete.php?id=" + enquiryId;
