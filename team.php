...
<head>
    ...
    <meta name="description" content="Concrete Arts India is a Mumbai manufacturer of concrete planters, benches, GRC jali, FRP products, statues and custom architectural solutions for residential, commercial and landscape projects across India.">    <meta name="author" content="Concrete Arts India">
    ...
    <title>Our Team | Concrete Arts India | GRC, FRP & Architectural Experts</title>
    <link rel="canonical" href="https://concreteartsindia.in/team.php">
    <link rel="icon" href="images/favicon.ico" type="image/x-icon">
    <link rel="stylesheet" href="css/style.css?v=<?= filemtime('css/style.css') ?>">
    <link rel="stylesheet" href="css/team.css?v=<?= filemtime('css/team.css') ?>">
        ...
        <section class="team section-padding">
            <div class="container">
                <div class="section-heading">
                    <span>OUR TEAM</span>
                    <h2>Meet the Experts Behind Our Craft</h2>
                    <p>
                        Our experienced professionals combine creativity, craftsmanship,
                        and engineering expertise to deliver premium architectural
                        concrete, GRC, FRP, and landscape solutions across India.
                    </p>
                </div>
                ...
                <div class="team-grid">
                    ...
                    <div class="team-card">
                        <img src="images/team/bharat-jadav.webp" alt="Founder & Managing Director">
                        <div class="team-content">
                            <h2>Bharat Jadav</h2>
                            <h3>Founder & Managing Director</h3>
                            <p>
                                Providing strategic leadership and driving innovation in architectural concrete,
                                GRC, FRP, and landscape solutions while ensuring exceptional quality and customer
                                satisfaction.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="team-card">
                        ...
                        <div class="team-content">
                            ...
                            <p>
                                Planning and executing structural and architectural projects with a focus on
                                quality, durability, and compliance with engineering standards.
                            </p>
                        </div>
                    </div>

                    <div class="team-card">
                        <img src="images/team/pankaj-gupta.webp" alt="Civil Engineer">
                        <div class="team-content">
                            <h2>Pankaj Gupta</h2>
                            <h3>Civil Engineer</h3>
                            <p>
                                Managing project execution, site coordination, and technical planning to deliver
                                reliable and sustainable construction solutions.
                            </p>
                        </div>
                    </div>

                    <div class="team-card">
                        <img src="images/team/vinod-halapati.webp" alt="Architect">
                        <div class="team-content">
                            <h2>Vinod Halapati</h2>
                            <h3>Architect</h3>
                            <p>
                                Designing innovative architectural concepts that combine functionality,
                                aesthetics, and modern construction techniques.
                            </p>
                        </div>
                    </div>

                    <div class="team-card">
                        <img src="images/team/vipul-patel.webp" alt="GRC Architect">
                        <div class="team-content">
                            <h2>Vipul Patel</h2>
                            <h3>GRC Architect</h3>
                            <p>
                                Specializing in Glass Reinforced Concrete (GRC) designs, creating durable,
                                lightweight, and visually striking architectural elements.
                            </p>
                        </div>
                    </div>

                    <div class="team-card">
                        <img src="images/team/aakash-acharya.webp" alt="Planter Design Specialist">
                        <div class="team-content">
                            <h2>Aakash Acharya</h2>
                            <h3>Planter Design Specialist</h3>
                            <p>
                                Developing creative planter designs that blend contemporary aesthetics with
                                practical functionality for indoor and outdoor spaces.
                            </p>
                        </div>
                    </div>

                    <div class="team-card">
                        <img src="images/team/paresh-solanki.webp" alt="Records & Administration Executive">
                        <div class="team-content">
                            <h2>Paresh Solanki</h2>
                            <h3>Records & Administration Executive</h3>
                            <p>
                                Maintaining company records, documentation, and administrative operations to
                                ensure efficient workflows and organized business processes.
                            </p>
                        </div>
                    </div>

                    <div class="team-card">
                        <img src="images/team/pawan-maurya.webp" alt="Accounts & Billing Executive">
                        <div class="team-content">
                            <h2>Pawan Maurya</h2>
                            <h3>Accounts & Billing Executive</h3>
                            <p>
                                Managing accounts, billing, invoicing, payment processing, and financial records
                                while ensuring timely and accurate transactions.
                            </p>
                        </div>
                    </div>

                    <div class="team-card">
                        <img src="images/team/rohit-kanekar.webp" alt="Website Developer">
                        <div class="team-content">
                            <h2>Rohit Kanekar</h2>
                            <h3>Website Developer</h3>
                            <p>
                                Designing and developing responsive, high-performance website applications that
                                deliver seamless user experiences and strengthen the company's digital presence.
                            </p>
                        </div>
                    </div>
