...
<head>
    ...
    <meta name="description"
        content="Browse the Concrete Arts India gallery featuring concrete planters, benches, GRC products, statues, landscape furniture and completed projects.">
    <meta name="keywords"
    ...
    <title>Concrete Products Gallery | GRC, Planters, Benches & Statues | Concrete Arts India</title>
    <link rel="canonical" href="https://concreteartsindia.in/gallery.php">
...
<body>
    ...
    <script src="js/gallery.js?v=<?= filemtime('js/gallery.js') ?>"></script>
